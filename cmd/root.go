...
import (
	...
	dbInfra "github.com/JoaoLeonello/hex-arch-studies/adapters/db"
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.hex-arch-studies.yaml)")
